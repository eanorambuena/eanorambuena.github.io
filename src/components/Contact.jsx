  ...
  return (
    <section id="contact" class="py-36 px-4 relative">
      <div class="max-w-2xl mx-auto text-center">
        ...
        <p class="text-zinc-100 text-lg mb-10 max-w-lg mx-auto leading-relaxed">
          {t.contact.desc}
        </p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            ...
            class="px-8 py-3.5 border border-zinc-600 hover:border-purple-500/50 rounded-xl font-medium transition-all duration-300 hover:scale-105 active:scale-95"
          >
            {t.contact.btnLinkedin}
          </a>
        </div>
        <div class="flex gap-6 justify-center mt-10 text-zinc-100">
        ...
        <p class="text-zinc-300 text-sm mt-8">
