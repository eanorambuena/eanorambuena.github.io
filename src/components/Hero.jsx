            ...
            <div class="space-y-8">
              <div class="space-y-4">
                ...
                <p class="text-lg text-gray-400 leading-relaxed max-w-md">
                  Fullstack product engineer based in Chile.
                  <span class="text-purple-400/80"> I build tools that save real money — reduced AI infra costs from $200/user to $0, built platforms serving 1,500+ concurrent users.</span>
                </p>
              </div>
