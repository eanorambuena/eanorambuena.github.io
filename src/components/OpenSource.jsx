    ...
    <section id="opensource" class="py-28 px-4 relative">
      <div class="max-w-3xl mx-auto">
        <div class="text-center mb-16">
          ...
          <p class="text-gray-400 mt-4 max-w-md mx-auto">Tools I've built and shared with the community.</p>
        </div>
        <div class="max-w-lg mx-auto">
          {repos.map((repo) => (
            <a
              ...
              class="group block bg-dark-800/40 backdrop-blur-sm border-2 border-purple-500/10 hover:border-purple-500/30 rounded-2xl p-8 text-center transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/5"
            >
              ...
              <p class="text-gray-300 text-sm mb-4 max-w-sm mx-auto leading-relaxed">{repo.description}</p>
        ...
        <div class="text-center mt-10">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="text-sm text-gray-400 hover:text-purple-400 transition-colors font-medium"
          >
