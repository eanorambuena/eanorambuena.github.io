    ...
    <section id="opensource" class="py-28 px-4 relative">
      <div class="max-w-3xl mx-auto">
        <div class="text-center mb-16">
          ...
          <p class="text-gray-300 mt-4 max-w-md mx-auto">Tools I've built and shared with the community.</p>
        </div>
        <div class="max-w-lg mx-auto">
          {repos.map((repo) => (
            ...
            >
              ...
              <p class="text-gray-200 text-sm mb-4 max-w-sm mx-auto leading-relaxed">{repo.description}</p>
