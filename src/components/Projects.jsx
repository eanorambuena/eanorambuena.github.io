...
function ProjectCard({ project, index }) {
  return (
    <ScrollReveal delay={index * 100}>
      <div class="group relative bg-dark-800/40 backdrop-blur-sm border border-gray-800 hover:border-purple-500/40 rounded-2xl p-6 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple-500/5">
      ...
      <div class="max-w-5xl mx-auto">
        <ScrollReveal>
          <div class="text-center mb-20">
            ...
            <p class="text-gray-500 mt-4 max-w-md mx-auto">Real products shipped for real users — from open source to fintech to mining.</p>
          </div>
        </ScrollReveal>
